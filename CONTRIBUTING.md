...
Love react-boilerplate-cra-template-custom and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/react-boilerplate/react-boilerplate-cra-template-custom/issues) is
